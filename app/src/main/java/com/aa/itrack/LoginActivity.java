...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIdView = (AutoCompleteTextView) findViewById(R.id.userId);
...
//            mAuthTask.execute((Void) null);
            ...
            //Forward to the MainActivity
            Intent mainActivityIntent = new Intent(this, MainActivity.class);
            startActivity(mainActivityIntent);

//            Snackbar.make(mLoginFormView, "MainActivity", Snackbar.LENGTH_LONG)
...
//        return id.contains("@");
    ...
    public Loader<Cursor> onCreateLoader(int i, Bundle bundle) {
        return new CursorLoader(this,
                ...
                // Show primary id first. Note that there won't be
                // a primary id if the user hasn't specified one.
    ...
    private void addIdsToAutoComplete(List<String> ids) {
